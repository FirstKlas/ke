...
function icaTestCtrl($scope, angularFire) {

    var url = 'https://fb02.firebaseio.com/Categories/Livsmedel/ItemsToBuy/';
    var promise = angularFire(url, $scope, 'items', {});
    $scope.itemOrderProp = '-Amount';

    promise.then(function (items) {
        $scope.nisse = conv(items);
...
function addItemCtrl($scope, angularFire) {

    var url = 'https://fb02.firebaseio.com/Items/';
    var promise = angularFire(url, $scope, 'items', {});
...
function ekonomiCtrl($scope, $window, Firebase, angularFireCollection) {
